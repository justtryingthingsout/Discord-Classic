...
+ (instancetype)standardParser {
    ...
    [defaultParser addParagraphParsingWithFormattingBlock:^(NSMutableAttributedString *attributedString, NSRange range) {
        ...
        [attributedString addAttribute:NSForegroundColorAttributeName
                                 value:[UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1]
                                 range:range];
    }];
...
static NSString *const TSMarkdownImageRegex = @"\\!\\[.*?\\]\\(\\S*\\)"; // keep if needed for parsing but won't render
