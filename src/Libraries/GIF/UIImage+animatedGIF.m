...
static int delayCentisecondsForImageAtIndex(
    CGImageSourceRef const source, size_t const i
) {
...
static void createImagesAndDelays(
...
static NSArray *frameArray(
    size_t const count,
    CGImageRef const images[count],
